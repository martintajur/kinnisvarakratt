			...
			.get('objects', function(err, rows) {
				if (req.url.match(/html/)) {
					...
					_.each(rows, function(row) {
						markup += '<li value="' + row.id + '" style="display: block; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;"><a href="' + row.url + '">' + row.type + ' (€' + row.price + ')</a> <small><script>document.write(moment("' + row.add_time + '").fromNow());</script> ... ' + row.text + '</small></li>';
					});
					markup += '</ol></body></html>';
					res.end(markup);
				}
...
var scraper = function(bindNext) {
	...
	setTimeout(function() {
		kvSearch('majaosa', 'http://www.kv.ee/?act=search.simple&company_id=&broker_id=&recent=0&coords=&price_m2_min=0&price_m2_max=0&bid_objects=&years_default=20&deposite_in_percents_default=30&intress_default=3.5&agent=0age_size=100&deal_type=11&county=1&parish=421&energy_cert_val=0&price_min=' + config.search.majaosa.minHind + '&price_max=' + config.search.majaosa.maxHind + '&price_type=1&keyword=&floors_min=&floors_max=&area_total_min=' + config.search.majaosa.minSuurus + '&area_total_max=&area_ground_min=&area_ground_max=&search=Otsi&orderby=cdwl&recent=1');
	}, buildTimeout());
	...
	setTimeout(function() {
		ekspressKinnisvaraSearch('majaosa', 'http://www.ekspresskinnisvara.ee/est/otsing/?ot=7&obj=0&t=1&m=1&lv=1&la=0&yp_a=' + config.search.majaosa.minSuurus + '&yp_k=&ks_a=&ks_k=&l1=2&h_a=' + config.search.majaosa.minHind + '&pk=1&h_k=' + config.search.majaosa.maxHind + '&l2=2&h2_a=&h2_k=&ea_a=&ea_k=&ta_a=&ta_k=&kv_a=&kv_k=&om=0&sk=0&my=0&m6=0&mt=0&lv2=0&ky=0&sort=U&sa=1&q=&otsi_bt.x=39&otsi_bt.y=17&fid=&mid=&__acform__reqid=');
	}, buildTimeout());
	...
	// City24.ee majaosad Tallinnas
	setTimeout(function() {
		city24Search('majaosa', { pageId: '4', objId: 'SearchObject', stateId: 'ShowResults', eventId: '', search_oldest: new moment().subtract('days', 4).format("DD.MM.YYYY"), search_reo_type: 'HOUSE_PART', search_trans: 'TRANSACTION_SALE', search_county: 'COUNTY_HARJUMAA', search_city: 'CITY_TALLINN', search_area1: config.search.majaosa.minSuurus, search_price1: config.search.majaosa.minHind, search_price2: config.search.majaosa.maxHind, search_size: 100 });
	}, buildTimeout());
	...
	// KV.ee majad Tallinnas
	setTimeout(function() {
		kvSearch('maja', 'http://www.kv.ee/?act=search.simple&deal_type=3&county=1&parish=421&energy_cert_val=0&price_min=' + config.search.maja.minHind + '&price_max=' + config.search.maja.maxHind + '&price_type=1&keyword=&search=Otsi&recent=1&orderby=cdwl');
	}, buildTimeout());
	...
	setTimeout(function() {
		ekspressKinnisvaraSearch('maja', 'http://www.ekspresskinnisvara.ee/est/otsing/?ot=2&obj=0&t=1&m=1&lv=1&la=0&yp_a=%27&yp_k=&ks_a=&ks_k=&l1=2&h_a=' + config.search.maja.minHind + '&h_k=' + config.search.maja.maxHind + '&pk=1&l2=2&h2_a=&h2_k=&ea_a=&ea_k=&ta_a=%27&ta_k=&kv_a=&kv_k=&om=0&sk=0&my=0&m6=0&mt=0&lv2=0&ky=0&sort=U&q=&otsi_bt.x=38&otsi_bt.y=12&fid=&mid=&__acform__reqid=');
	}, buildTimeout());
	...
	// City24.ee majad Tallinnas
	setTimeout(function() {
		city24Search('maja', { pageId: '4', objId: 'SearchObject', stateId: 'ShowResults', eventId: '', search_oldest: new moment().subtract('days', 4).format("DD.MM.YYYY"), search_reo_type: 'HOUSE_HOUSE', search_trans: 'TRANSACTION_SALE', search_county: 'COUNTY_HARJUMAA', search_city: 'CITY_TALLINN', search_price1: config.search.maja.minHind, search_price2: config.search.maja.maxHind, search_size: 100 });
	}, buildTimeout());
